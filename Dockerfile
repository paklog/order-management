# ============================================
# Multi-stage Dockerfile for Order Management Service
...
LABEL org.opencontainers.image.title="Order Management Service" \
      org.opencontainers.image.description="Fulfillment order lifecycle management service with event-driven integration" \
      org.opencontainers.image.version="${APP_VERSION}" \
      org.opencontainers.image.vendor="Paklog" \
      org.opencontainers.image.authors="Paklog Engineering Team" \
      org.opencontainers.image.source="https://github.com/paklog/order-management" \
